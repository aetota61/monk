...
// Resource paths.
const char kQuoteCSS[] = "quote.css";
#if BUILDFLAG(IS_IOS) || BUILDFLAG(IS_ANDROID)
const char kQuoteMobileCSS[] = "quote_mobile.css";
#endif
const char kQuoteJS[] = "quote.js";
...
const char kRequestQuote[] = "requestQuote";
// const char kRequestBlockAlways[] = "requestBlockAlways";
