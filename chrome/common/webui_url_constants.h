...
extern const char kChromeUIBlankTabPageHost[];
extern const char kChromeUIBlankTabPageURL[];
extern const char kChromeUIQuoteHost[];
extern const char kChromeUIQuoteURL[];
