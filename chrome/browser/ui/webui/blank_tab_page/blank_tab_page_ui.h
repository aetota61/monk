...
#ifndef CHROME_BROWSER_UI_WEBUI_BLANK_TAB_PAGE_BLANK_TAB_PAGE_UI_H_
#define CHROME_BROWSER_UI_WEBUI_BLANK_TAB_PAGE_BLANK_TAB_PAGE_UI_H_
...
class BlankTabPageUI : public content::WebUIController {
 public:
  explicit BlankTabPageUI(content::WebUI* web_ui);

  BlankTabPageUI(const BlankTabPageUI&) = delete;
  BlankTabPageUI& operator=(const BlankTabPageUI&) = delete;

  ~BlankTabPageUI() override;
...
#endif  // CHROME_BROWSER_UI_WEBUI_BLANK_TAB_PAGE_BLANK_TAB_PAGE_UI_H_
