...
#ifndef CHROME_BROWSER_UI_WEBUI_QUOTE_QUOTE_HANDLER_H_
#define CHROME_BROWSER_UI_WEBUI_QUOTE_QUOTE_HANDLER_H_
...
class QuoteHandler : public content::WebUIMessageHandler {
 public:
  QuoteHandler();

  QuoteHandler(const QuoteHandler&) = delete;
  QuoteHandler& operator=(const QuoteHandler&) = delete;
  ...
  // Callback for the "requestQuote" message.
  virtual void HandleRequestQuote(const base::Value::List& args);
 ...
 private:
  ...
  base::WeakPtrFactory<QuoteHandler> weak_ptr_factory_{this};
};

#endif  // CHROME_BROWSER_UI_WEBUI_QUOTE_QUOTE_HANDLER_H_
